...
public class SmartTravelForex {
    static  double JPY = 0.67;   // 1Yen == 0.67 INR
    ...
    public static double currentExchangeRates(double amount, int choice) {
       if(amount > 0){
          switch(choice){
              case 1: amount = amount * JPY;
              break;
              case 2: amount = amount * EUR;
              break;
              case 3: amount = amount * GBP;
              break;
              case 4: amount = amount * USD;
              break;
              case 5: amount = amount * AED;
          }
       }else{
        return amount = -1;
       }
    ...
    public static double convertGivenCurrencyIntoDesiredCurrency(int sourceCurrency, int targetCurrency, double amountToBeConverted) {
           if(sourceCurrency == 1){
               amountToBeConverted = amountToBeConverted * JPY;
               switch(targetCurrency){
                   case 1: amountToBeConverted = -1;
                   break;
                   case 2: amountToBeConverted = amountToBeConverted / EUR;
                   break;
                   case 3: amountToBeConverted = amountToBeConverted / GBP;
                   break;
                   case 4: amountToBeConverted = amountToBeConverted / USD;
                   break;
                   case 5: amountToBeConverted = amountToBeConverted / AED;
               }   

           }else if(sourceCurrency == 2){
                amountToBeConverted = amountToBeConverted * EUR;

                switch(targetCurrency){
                    case 1: amountToBeConverted = amountToBeConverted / JPY;
                    break;
                    case 2: amountToBeConverted = -1;
                    break;
                    case 3: amountToBeConverted = amountToBeConverted / GBP;
                    break;
                    case 4: amountToBeConverted = amountToBeConverted / USD;
                ...
                amountToBeConverted = amountToBeConverted * GBP;
            ...
            amountToBeConverted = amountToBeConverted * USD;
            ...
            amountToBeConverted = amountToBeConverted * AED;
                ...
                switch(targetCurrency){
                    ...
                    case 4: amountToBeConverted = amountToBeConverted / USD;
                    break;
                    case 5: amountToBeConverted = -1;
                    break;
                }
            }else{
                return amountToBeConverted = -1;
            }
        }
    ...
    public static void displayForexDetails() {
        ...
        System.out.println("AED    20.25   202.5   4050     1012.5    2025.0     ");
    }
